...
var activeCounty, activeDimension, allCountyData, axis, bb, blockContextMenu, canvasHeight, canvasWidth, color, colorDomains, compressData, compressedData, constant, containsAll, counties, countyAdded, dimension, dimensions, drawPC, drawVisualization, firstTime, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, keyFrame, labels, line, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, parseDate, path, pcBackground, pcBrush, pcForeground, pcFrame, pcNational, pcPath, pcScales, pcx, pcy, projection, resetChoropleth, scaleY, standardMargin, svg, text, timeSlice, usGeo, windowHeight, windowWidth, zeroes, zoomChoropleth, _i, _len, _ref, _ref1, _ref2;
...
drawVisualization = function(firstTime) {
  var allCountyValues, backgroundCounties, brush, brushed, countyData, dimensionExtent, g, handle, nationalValues, slider, sliderScale, timeslice, _j, _k, _l, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref3;
