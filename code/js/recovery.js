...
var activeCounty, activeDimension, allCountyData, bb, blockContextMenu, canvasHeight, canvasWidth, color, colorDomains, constant, counties, countyAdded, dates, dimensions, drawVisualization, firstTime, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, labels, mapContainer, mapFrame, mapMask, mapX, mapY, margin, modifyGraph, nationalData, parseDate, path, pcFrame, projection, resetChoropleth, scaleY, svg, usGeo, zeroes, zoomChoropleth, _ref, _ref1;
