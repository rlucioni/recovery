...
var activeCounty, activeDimension, allCountyData, axis, bb, blockContextMenu, brush, canvasHeight, canvasWidth, color, colorDomains, compressData, compressedData, constant, containsAll, counties, countyAdded, dimension, dimensions, drawPC, drawVisualization, firstTime, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, keyFrame, labels, line, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, parseDate, path, pcBackground, pcForeground, pcFrame, pcNational, pcPath, pcScales, pcx, pcy, projection, resetChoropleth, scaleY, standardMargin, svg, text, timeSlice, usGeo, windowHeight, windowWidth, zeroes, zoomChoropleth, _i, _len, _ref, _ref1, _ref2;
...
drawVisualization = function(firstTime) {
  var backgroundCounties, brushed, g, handle, nationalValues, slider, sliderScale;
