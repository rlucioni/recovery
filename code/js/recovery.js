...
pcBrush = function() {
  var activeCounties, actives, extents, graphactiveCounties, graphactives, graphextents, _j, _len1;
  activeCounties = {};
  graphactiveCounties = {};
  actives = [];
  extents = [];
...
drawVisualization = function(firstTime) {
  var allCountyValues, allValues, brush, brushed, count, county, countyData, dataRange, dimensionExtent, g, handle, ix, keyBoxPadding, keyBoxRatio, keyBoxSize, moveBrush, nationalValues, point, properties, roundedPosition, slider, sliderScale, swatch, timeslice, update, _j, _k, _l, _len1, _len10, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref3, _ref4, _ref5, _s;
  ...
  if (firstTime) {
    ...
    for (_j = 0, _len1 = allCountyData.length; _j < _len1; _j++) {
      ...
      for (_k = 0, _len2 = dataRange.length; _k < _len2; _k++) {
        ix = dataRange[_k];
  ...
  if (firstTime) {
    ...
    for (_n = 0, _len5 = compressedData.length; _n < _len5; _n++) {
      countyData = compressedData[_n];
    ...
    for (_r = 0, _len9 = dimensions.length; _r < _len9; _r++) {
      dimension = dimensions[_r];
  ...
  if (activeData !== null) {
    ...
    for (_s = 0, _len10 = _ref5.length; _s < _len10; _s++) {
      point = _ref5[_s];
      allValues.push(+point);
    }
  }
