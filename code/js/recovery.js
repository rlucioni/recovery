...
_ref2 = [null, null, null, null, null, null, null, null, null, null], counties = _ref2[0], yAxis = _ref2[1], nationalTitle = _ref2[2], vsText = _ref2[3], countyTitle = _ref2[4], yLabel = _ref2[5], nationalLine = _ref2[6], nationalPoints = _ref2[7], countyLine = _ref2[8], countyPoints = _ref2[9];
...
modifyGraph = function(d, nationalValues, t) {
  ...
  if (!countyAdded) {
    ...
    countyLine.datum(countyArray).classed("hidden", true).transition().delay(constant.graphDuration).duration(0.0).attr("d", graphLine).attr("class", "line county");
...
hasDataAllDimensions = function(d) {
  var hasAll, _k, _len2;
  hasAll = true;
  for (_k = 0, _len2 = dimensions.length; _k < _len2; _k++) {
    dimension = dimensions[_k];
...
drawVisualization = function(firstTime) {
  var allCountyValues, backgroundCounties, brush, brushed, count, countyData, dimensionExtent, g, handle, keyBoxPadding, keyBoxRatio, keyBoxSize, moveBrush, nationalValues, roundedPosition, slider, sliderScale, swatch, timeslice, update, _k, _l, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _m, _n, _o, _p, _q, _ref4, _ref5;
  ...
  if (firstTime) {
    ...
    for (_m = 0, _len4 = compressedData.length; _m < _len4; _m++) {
      countyData = compressedData[_m];
      for (_n = 0, _len5 = dimensions.length; _n < _len5; _n++) {
        dimension = dimensions[_n];
        _ref5 = countyData[dimension];
