...
var activeCounty, activeDimension, allCountyData, arc, bb, blockContextMenu, canvasHeight, canvasWidth, color, colorDomains, constant, counties, countyAdded, dimensions, drawPC, drawVisualization, firstTime, formatPercent, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, labels, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, parseDate, path, pcFrame, pcScales, progress, projection, resetChoropleth, scaleY, standardMargin, svg, text, total, twoPi, usGeo, windowHeight, windowWidth, zeroes, zoomChoropleth, _ref, _ref1;
