...
var activeCounty, activeDimension, allCountyData, arc, axis, bb, blockContextMenu, brush, canvasHeight, canvasWidth, color, colorDomains, compressData, compressedData, constant, containsAll, counties, countyAdded, dimension, dimensions, drawPC, drawVisualization, firstTime, formatPercent, graphContainer, graphFrame, graphLine, graphMask, graphXAxis, graphXScale, graphYAxis, graphYScale, graphedCountyId, labels, line, loadingContainer, mapContainer, mapFrame, mapMask, mapX, mapY, meter, modifyGraph, nationalData, parseDate, path, pcFrame, pcPath, pcScales, pcbackground, pcforeground, pcnational, pcx, pcy, progress, projection, resetChoropleth, scaleY, standardMargin, svg, text, total, twoPi, usGeo, windowHeight, windowWidth, zeroes, zoomChoropleth, _i, _len, _ref, _ref1, _ref2;
...
drawVisualization = function(firstTime) {
  var backgroundCounties, g, nationalPoints, nationalValues, timeSlice;
