...
_ref2 = [null, null, null], pcForeground = _ref2[0], pcBackground = _ref2[1], pcNational = _ref2[2];
...
drawVisualization = function(firstTime) {
  ...
  if (firstTime) {
    ...
    return slider.transition().delay(2500).duration(2500).call(brush.event).call(brush.extent([nationalData.dates.length * 0.25, nationalData.dates.length * 0.25])).call(brush.event);
  } else {
