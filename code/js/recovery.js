...
drawVisualization = function(firstTime) {
  var allCountyValues, allValues, brush, brushed, count, county, countyData, dataRange, dimensionExtent, g, handle, ix, keyBoxPadding, keyBoxRatio, keyBoxSize, moveBrush, nationalValues, point, properties, roundedPosition, slider, sliderScale, swatch, timeslice, update, _k, _l, _len10, _len11, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref4, _ref5, _ref6, _s, _t;
  ...
  if (firstTime) {
    ...
    for (_o = 0, _len6 = compressedData.length; _o < _len6; _o++) {
      countyData = compressedData[_o];
    ...
    for (_s = 0, _len10 = dimensions.length; _s < _len10; _s++) {
      dimension = dimensions[_s];
  ...
  if (activeData !== null) {
    _ref6 = activeData.properties[activeDimension];
    for (_t = 0, _len11 = _ref6.length; _t < _len11; _t++) {
      point = _ref6[_t];
      allValues.push(+point);
    }
  }
