...
var DIMENSION, active, bb, blockContextMenu, canvasHeight, canvasWidth, clicked, color, constant, drawVisualization, graphFrame, graphLine, graphXAxis, graphXScale, graphYAxis, graphYScale, mapContainer, mapFrame, mapMask, mapX, mapY, margin, path, pcFrame, projection, reset, svg;
...
graphLine = d3.svg.line().interpolate("linear").x(function(d) {
  return graphXScale(d.properties[DIMENSION].date);
}).y(function(d) {
  return graphYScale(d.properties[DIMENSION].value);
});
