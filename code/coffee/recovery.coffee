...
overlayContent = ["This tutorial will guide you through the four main components of this interactive visualization.",
                "<strong>Left-click</strong> a county to zoom in and pan to it. An <span style=\"color:#fd8d3c\">orange border</span> will surround the selected county. <strong>Left-click</strong> the same county to zoom back out.",
